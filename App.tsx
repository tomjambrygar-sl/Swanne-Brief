...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white antialiased text-[#1A1A1A] selection:bg-[#C58E7E]/20">
      <main className="max-w-[720px] mx-auto px-6 pt-16 pb-32">
        
        {/* Navigation / Header Bar */}
        <header className="mb-20">
          <div className="space-y-2 mb-8 text-center md:text-left">
            <h1 className="text-[28px] md:text-[32px] tracking-[0.05em] text-black leading-tight font-bold">
              Swanne Viral Brief
            </h1>
          ...
          <div className="max-w-lg space-y-8 text-center md:text-left mx-auto md:mx-0">
            <p className="text-[#4A4A4A] text-[16px] leading-relaxed font-light">
            ...
            <div className="flex flex-wrap gap-3 justify-center md:justify-start">
              <button 
                ...
                className="inline-block px-6 py-2.5 border border-stone-200 text-stone-500 text-[10px] font-bold tracking-[0.15em] uppercase rounded-full hover:bg-stone-50 hover:text-black hover:border-stone-400 transition-all active:scale-95"
              >
                Viral Brief
              </button>
              <button 
